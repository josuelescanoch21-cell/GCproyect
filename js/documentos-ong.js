...
async function render(){
  ...
  if(!['editor','admin'].includes(session.rol)){ board.innerHTML = '<section class="auth-required-panel"><h2>Solo para editores</h2><p>Esta sección está orientada a personas o compañías que crearán o gestionarán una ONG.</p></section>'; return; }
  ...
  await logProcess('editor_revisa_estado_documentos', session.rol, { total: docs.length });
}
